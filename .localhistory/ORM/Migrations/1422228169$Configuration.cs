        ...
        private static void AddPosts(ForumContext context)
        {
            ...
            var rockMetalPosts = new List<Post>
            {
                ...
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("19-07-2005, 12:52 PM"),
                ...
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("06-05-2009, 09:08 AM"),
            ...
            var jazzBluesPosts = new List<Post>
            {
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("27-06-2005, 03:57 PM"),
                    CreatorId = context.Users.Single(u => u.Name == "anticipation").Id,
            ...
            var popPosts = new List<Post>
            {
                ...
                new Post
                {
                    Name = "Billy Joel",
                    Description = null,
                    CreationTime = DateTime.Parse("26-02-2012, 01:24 PM"),
                ...
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("05-03-2014, 09:05 PM"),
