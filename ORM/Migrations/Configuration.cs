    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ForumContext>
    {
        ...
        private static void AddUsers(ForumContext context)
        {
            var users = new List<User>
            {
                new User
                {
                    ...
                    DateOfBirth = DateTime.Parse("18-02-1994 09:35:00").ToUniversalTime(),
                    JoinDate = DateTime.Parse("01-01-2015").ToUniversalTime(),
                ...
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("13-04-2009").ToUniversalTime(),
                    LastActivity = DateTime.Parse("25-12-2010 07:55 AM").ToUniversalTime(),
                ...
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("07-11-2004").ToUniversalTime(),
                    LastActivity = DateTime.Parse("27-04-2009 02:54 PM").ToUniversalTime(),
                    Location = null,
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("15-06-2005").ToUniversalTime(),
                    LastActivity = DateTime.Parse("30-12-2014 07:01 AM").ToUniversalTime(),
                    Location = null,
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    Name = "Pet_Sounds",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("01-01-2000").ToUniversalTime(),
                    JoinDate = DateTime.Parse("17-02-2014").ToUniversalTime(),
                    LastActivity = DateTime.Parse("26-12-2014 09:34 PM").ToUniversalTime(),
                    Location = null,
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("28-11-2011").ToUniversalTime(),
                    LastActivity = DateTime.Parse("19-12-2011 04:04 PM").ToUniversalTime(),
                    Location = "England",
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("08-12-2005").ToUniversalTime(),
                    LastActivity = DateTime.Parse("09-02-2008 09:24 PM").ToUniversalTime(),
                    Location = null,
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("01-01-2006").ToUniversalTime(),
                    LastActivity = DateTime.Parse("19-09-2006 08:39 PM").ToUniversalTime(),
                    Location = null,
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("07-01-2013").ToUniversalTime(),
                    LastActivity = DateTime.Parse("07-01-2013 10:55 AM").ToUniversalTime(),
                ...
                new User
                {
                    Name = "Plankton",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("August 30, 1966").ToUniversalTime(),
                    JoinDate = DateTime.Parse("30-04-2012").ToUniversalTime(),
                    LastActivity = DateTime.Parse("31-12-2014 02:26 PM").ToUniversalTime(),
                ...
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("24-02-2012").ToUniversalTime(),
                    LastActivity = DateTime.Parse("02-10-2013 04:15 AM").ToUniversalTime(),
                    Location = "Tennessee",
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("11-01-2013").ToUniversalTime(),
                    LastActivity = DateTime.Parse("20-01-2013 12:18 AM").ToUniversalTime(),
                    Location = "USA",
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    Name = "Rjinn",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("01-01-1988").ToUniversalTime(),
                    JoinDate = DateTime.Parse("26-06-2012").ToUniversalTime(),
                    LastActivity = DateTime.Parse("16-11-2014 02:05 AM").ToUniversalTime(),
                ...
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("04-04-2011").ToUniversalTime(),
                    LastActivity = DateTime.Parse("05-12-2014 04:20 PM").ToUniversalTime(),
                    Location = "So-Cal",
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    Name = "Kurt_Cobain",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("September 27, 1986").ToUniversalTime(),
                    JoinDate = DateTime.Parse("05-02-2005").ToUniversalTime(),
                    LastActivity = DateTime.Parse("19-06-2014 08:25 AM").ToUniversalTime(),
                ...
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("03-08-2006").ToUniversalTime(),
                    LastActivity = DateTime.Parse("27-03-2014 06:41 AM").ToUniversalTime(),
                    Location = null,
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    Name = "Seltzer",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("May 4, 1988").ToUniversalTime(),
                    JoinDate = DateTime.Parse("02-12-2005").ToUniversalTime(),
                    LastActivity = DateTime.Parse("21-04-2012 07:03 PM").ToUniversalTime(),
                ...
                new User
                {
                    Name = "lucifer_sam",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("01-01-1989").ToUniversalTime(),
                    JoinDate = DateTime.Parse("27-06-2008").ToUniversalTime(),
                    LastActivity = DateTime.Parse("06-12-2011 01:19 AM").ToUniversalTime(),
                ...
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("19-07-2007").ToUniversalTime(),
                    LastActivity = DateTime.Parse("22-01-2012 03:02 AM").ToUniversalTime(),
                ...
                new User
                {
                    Name = "TheBig3",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("November 22, 1982").ToUniversalTime(),
                    JoinDate = DateTime.Parse("23-08-2004").ToUniversalTime(),
                    LastActivity = DateTime.Parse("01-01-2015 01:49 AM").ToUniversalTime(),
                ...
                new User
                {
                    ...
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = null,
                    JoinDate = DateTime.Parse("21-12-2004").ToUniversalTime(),
                    LastActivity = DateTime.Parse("26-12-2014 12:37 PM").ToUniversalTime(),
                ...
                new User
                {
                    Name = "Enfilade",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("August 14, 1989").ToUniversalTime(),
                    JoinDate = DateTime.Parse("09-12-2004").ToUniversalTime(),
                    LastActivity = DateTime.Parse("19-06-2005 09:14 PM").ToUniversalTime(),
                    Location = "Places",
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                },
                new User
                {
                    Name = "Sneer",
                    Password = Crypto.HashPassword("123456"),
                    DateOfBirth = DateTime.Parse("September 1, 1987").ToUniversalTime(),
                    JoinDate = DateTime.Parse("01-11-2004").ToUniversalTime(),
                    LastActivity = DateTime.Parse("27-12-2011 12:55 PM").ToUniversalTime(),
                    Location = null,
                    IsOnline = false,
                    Roles = context.Roles.Where(r => r.Name == "Reader").ToList()
                }
        ...
        private static void AddCategories(ForumContext context)
        {
            var categories = new List<Category>
            {
                new Category
                {
                    Name = "Music News",
                    Description = null,
                    CreationTime = DateTime.Parse("09-08-2012, 04:31 AM").ToUniversalTime(),
                ...
                new Category
                {
                    Name = "Music Genres",
                    Description = null,
                    CreationTime = DateTime.Parse("16-01-2005, 02:38 PM").ToUniversalTime(),
                    CreatorId = context.Users.Single(u => u.Name == "Admin").Id
                },
                new Category
                {
                    Name = "Artists Corner",
                    Description = null,
                    CreationTime = DateTime.Parse("03-01-2006, 03:16 AM").ToUniversalTime(),
                    CreatorId = context.Users.Single(u => u.Name == "Admin").Id
                }
            };
        ...
        private static void AddTopics(ForumContext context)
        {
            var musicNewsTopics = new List<Topic>
            {
                ...
                new Topic
                {
                    ...
                    CreationTime = DateTime.Parse("14-06-2013, 08:42 PM").ToUniversalTime(),
                    CreatorId = context.Users.Single(u => u.Name == "Admin").Id,
                    CategoryId = context.Categories.Single(c => c.Name == "Music News").Id
                }
            };
            ...
            var musicGenresTopics = new List<Topic>
            {
                ...
                new Topic
                {
                    ...
                    CreationTime = DateTime.Parse("30-05-2005, 07:40 AM").ToUniversalTime(),
                    CreatorId = context.Users.Single(u => u.Name == "Admin").Id,
                    CategoryId = context.Categories.Single(c => c.Name == "Music Genres").Id
                },
                new Topic
                {
                    ...
                    CreationTime = DateTime.Parse("03-07-2008, 08:48 AM").ToUniversalTime(),
                    CreatorId = context.Users.Single(u => u.Name == "Admin").Id,
                    CategoryId = context.Categories.Single(c => c.Name == "Music Genres").Id
                }
            };
            ...
            var artistsCornerTopics = new List<Topic>
            {
                ...
                new Topic
                {
                    ...
                    CreationTime = DateTime.Parse("06-09-2012, 01:31 PM").ToUniversalTime(),
                    CreatorId = context.Users.Single(u => u.Name == "Admin").Id,
                    CategoryId = context.Categories.Single(c => c.Name == "Artists Corner").Id
                }
            };
        ...
        private static void AddPosts(ForumContext context)
        {
            var albumReviewsPosts = new List<Post>
            {
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("14-11-2014, 07:09 PM").ToUniversalTime(),
            ...
            var rockMetalPosts = new List<Post>
            {
                ...
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("19-07-2005, 12:52 PM").ToUniversalTime(),
                ...
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("06-05-2009, 09:08 AM").ToUniversalTime(),
            ...
            var jazzBluesPosts = new List<Post>
            {
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("27-06-2005, 03:57 PM").ToUniversalTime(),
                    CreatorId = context.Users.Single(u => u.Name == "anticipation").Id,
            ...
            var popPosts = new List<Post>
            {
                ...
                new Post
                {
                    Name = "Billy Joel",
                    Description = null,
                    CreationTime = DateTime.Parse("26-02-2012, 01:24 PM").ToUniversalTime(),
                ...
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("05-03-2014, 09:05 PM").ToUniversalTime(),
            ...
            var talkInstrumentsPosts = new List<Post>
            {
                ...
                new Post
                {
                    ...
                    Description = null,
                    CreationTime = DateTime.Parse("07-01-2013, 10:54 AM").ToUniversalTime(),
        ...
        private static void AddReplies(ForumContext context)
        {
            var theOfficialPinkFloydThreadReplies = new List<Reply>
            {
                new Reply
                {
                    WrittenTime = DateTime.Parse("16-01-2005, 02:38 PM").ToUniversalTime(),
                    IsSubject = true,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("16-01-2005, 02:56 PM").ToUniversalTime(),
                    IsSubject = false,
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("17-01-2005, 04:38 PM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("18-01-2005, 03:34 AM").ToUniversalTime(),
                    IsSubject = false,
            ...
            var eltonJohnReplies = new List<Reply>
            {
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-07-2008, 08:48 AM").ToUniversalTime(),
                    IsSubject = true,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-07-2008, 08:51 AM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-07-2008, 02:33 PM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-07-2008, 02:39 PM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-07-2008, 02:54 PM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
...
If you listen to one song you've never heard before today, make it Border Song.",
            ...
            var whatsYourFavGuitarReplies = new List<Reply>
            {
                new Reply
                {
                    WrittenTime = DateTime.Parse("07-01-2013, 10:54 AM").ToUniversalTime(),
                    IsSubject = true,
...
I don't know, I really liked the feel of it. I know it's not the best guitar, It's just my favourite.",
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("07-01-2013, 11:35 AM").ToUniversalTime(),
                    IsSubject = false,
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("07-01-2013, 02:38 PM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("11-01-2013, 03:10 AM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
            ...
            var talkAboutYourInstrumentGearReplies = new List<Reply>
            {
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-01-2006, 03:16 AM").ToUniversalTime(),
                    IsSubject = true,
                    Content =
...
...You become a better drummer this way!!!Just try for yourself, peace!!!",
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-01-2006, 03:18 AM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-01-2006, 03:29 AM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
...
...I guess they're the one's costing me all this money, ya know?Otherwise, I got a great sounding kit and wouldn't necessarily need the Roland V-Drums, see?",
                ...
                new Reply
                {
                    WrittenTime = DateTime.Parse("03-01-2006, 03:36 AM").ToUniversalTime(),
                    IsSubject = false,
                    Content =
